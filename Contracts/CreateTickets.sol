...
contract CreateTickets is SikkerStats {
    ...
    function _CreateTMM(
        ...
        /*if (_timeLock > 0)
            emit CreatedTicket(TMM_Ticket_Number, "Take My Money", _ticket.Amount, _ticket.Creator, false, 0x000000000000000000000000000000000000dEaD, _percent);
        else
            emit CreatedTicket(TMM_Ticket_Number, "Take My Money", _ticket.Amount, _ticket.Creator, false, 0x000000000000000000000000000000000000dEaD, 0);*/
    }
}