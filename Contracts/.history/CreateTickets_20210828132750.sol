...
contract _CreateTickets is Sikker {
    ...
    IsAsshole(_amount, _hash) {
        ...
        CE_Ticket_Number = CE_Ticket_Number.add(1);
    ...
    function _CreateTMM(uint64 _amount, bytes32 _hash, uint8 _percent, uint256 _timeLock) public payable
    IsAsshole(_amount, _hash) {
        ...
        TotalValueEverLocked = TotalValueEverLocked.(_ticket.Amount);
        TMM_Ticket_Number = TMM_Ticket_Number.add(1);
