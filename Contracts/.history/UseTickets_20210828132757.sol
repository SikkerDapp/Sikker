...
contract _UseTickets is _CreateTickets {
    ...
    PasswordCheck(_password, _CE_Tickets[_id].Hash) StatusCheck(_CE_Tickets[_id].Status, 1) TimeCheck(_CE_Tickets[_id].TimeLock, 0, _id) {
        ...
        if (_CE_Tickets[_id].Status == 0) {
            ...
            TotalValueEverLocked = TotalValueEverLocked.add(_CE_Tickets[_id].Amount);
            ...
            CE_Inactive_Ticket_Number = CE_Inactive_Ticket_Number.add(1);
            TotalValueUnlocked = TotalValueUnlocked.add(_CE_Tickets[_id].Amount);
    ...
    function _UseTMM(bytes memory _password, uint256 _id) public
        ...
        TMM_Inactive_Ticket_Number = TMM_Inactive_Ticket_Number.add(1);
        TotalValueUnlocked = TotalValueUnlocked.add(_TMM_Tickets[_id].Amount);
